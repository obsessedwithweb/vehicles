document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- Sample Product Data ---
   const productsData = [
      { id: 'bike001', name: 'Air Flow Meter 1.9 Dti', price: 450.00, image: '17.jpg', description: 'Air flow meter 1.9 Dti Original Renault New in Packaging.' },
      { id: 'bike002', name: 'Master3 Steering Pump', price: 320.50, image: '18.jpg', description: 'Master3 Steering Pump Original Renault New in Packaging.' },
      { id: 'bike003', name: 'Caddy Led Ballast', price: 780.00, image: '19.jpg', description: 'Genuine DELPHI LED Power Module for Volkswagen Caddy.' },
      { id: 'bike004', name: 'Stepway Steering Pump', price: 150.00, image: '20.jpg', description: 'Original Electric Stepway..Symbol2 1.5Dci Steering Pump.' },
      { id: 'bike005', name: 'Heating Motor', price: 1200.00, image: '21.jpg', description: 'Kangoo 2 Heater Motor Original Renault New in Packaging.' },
      { id: 'bike006', name: 'New Opel Zafira seat', price: 550.75, image: '22.jpg', description: 'New seat for Opel Zafira 7 seats, high quality and comfortable.' },
      { id: 'bike007', name: 'Clutch Transmitter', price: 410.00, image: '23.jpg', description: 'Suzuki Grand Vitara 1.9 DDIS Transmission,ORIGINAL JAPAN.' },
      { id: 'bike008', name: 'Car Door', price: 680.00, image: '24.jpg', description: 'High quality Golf 7 right front door.' } ,
      { id: 'bike009', name: 'Car Headlight', price: 695.00, image: '25.jpg', description: 'JAGUAR I-PACE (X590) (2018-present) Left Front Headlight J9D3.' },
      { id: 'bike010', name: 'Right Rearview Mirror', price: 695.00, image: '26.jpg', description: 'Right side mirror Megane 3 1.9 dci folding original Renault.' },
      { id: 'bike011', name: 'The Chevrolet Trunk', price: 695.00, image: '27.jpg', description: 'The black trunk for Chevrolet New Spark Year 2013.' },
      { id: 'bike012', name: 'Rear Lights', price: 695.00, image: '28.jpg', description: 'Audi Q3 LED Tail Lights, Excellent Quality, Red.'},
      { id: 'bike013', name: 'Hyundai I20 Hood', price: 695.00, image: '29.jpg', description: 'Hyundai i20 Black Balloon Engine Cover High Quality.' },
      { id: 'bike014', name: 'Heater Motor', price: 695.00, image: '30.jpg', description: 'Heater motor for Renault Clio IV Logan Symbol Kangoo Sander.'},
      { id: 'bike015', name: 'AC Regulator', price: 695.00, image: '31.jpg', description: 'Pregio Kia K2700 AC Regulator Original Quality.' }
  ];
